+++
title = "The second tranche and anniversary reflection"
date = 2025-10-18
authors = ["knadh"]
description = "Announcement of the full $1 million allocation, lessons, and future plans"
+++
...
We are happy to announce the second and final tranche of 2025, totaling **$675,000**. Along with the $325,000 from the [first tranche](@/blog/update-2025-may.md), this brings the total to $1 million for the year. All projects and tranches can be [tracked here](@/projects/_index.md).

We will be reaching out to all recipients in the coming days to initiate the due processes and formalities.

{{ status_table(year="2025", tranche="2") }}
...
* The [funding.json](https://fundingjson.org) experiment has done really well.
...
How the [funding.json](https://fundingjson.org) open schema has fared has been particularly exciting to me. The issues it aims to address, and the motivations and experiences that culminated in its creation, have been problems I've mulled over for a long time. They are described in detail in the [original announcement](@/blog/announcing-floss-fund.md#more-structure-funding-json).
...
* There has been a positive, natural acceptance of funding.json as the means of applying to FLOSS/fund. We've received very few (angry) e-mails asking for a web form, and that's a pretty big achievement in the FOSS world `¯\_(ツ)_/¯`
* Entities both large and small have thoughtfully presented their broad financial requirements aimed at the general public in their funding.json, rather than just publishing namesake entries specifically aimed at FLOSS/fund. This ranges from $5 monthly individual donations to $500K corporate payments to solicitation of funds via support contracts. This is precisely the goal of the manifest. We do not want FLOSS or the fund to have any form of exclusivity; instead, we want to encourage projects to publicly share their financial requirements with the world. Two examples: [openstreetmap.org/funding.json](https://www.openstreetmap.org/funding.json) and [ziglang.org/funding.json](https://ziglang.org/funding.json).
* In reality, there is no "applying" to FLOSS/fund. A project publishes its funding requirements as a public, machine-readable manifest and adds it to the FLOSS/fund [open directory](https://dir.floss.fund). The fund reviews public listings and makes its selections periodically. There is no other "application" process or status tracking. Anyone anywhere, and not just FLOSS/fund, can browse the open directory and pick projects to support. I'm positive that more tooling around these manifests will emerge, like this [live analysis](https://floss-fund-live-status.streamlit.app/) of the open directory.
* The manifest makes FOSS funding, grant applications, and financial solicitation portable. Write and publish once, apply anywhere. Unlike applications for awards or one-off events, funding requirements of FOSS projects are recurring, long-standing, and inherently public. The idea of an open JSON manifest captures these dynamics. Imagine a project applying to [NLNet](https://nlnet.nl), the [German Sovereign Tech Fund](https://www.sovereign.tech), FLOSS/fund, and several others without having to craft entirely new grant applications. The EU already has [Europass](https://en.wikipedia.org/wiki/Europass) for portable, machine-readable CVs for jobseekers. funding.json is basically that, but for FOSS projects. Informal conversations I have had about funding.json's adoption in other contexts has been good validation.
...
The biggest lesson of all is the continued reaffirmation that many super-big, super-critical projects that we assume are doing okay, are so under-funded and under-resourced, it is scary. The reality is that the criticality and extent of usage of a FOSS project often has no positive correlation with its health or sustainability. [xkcd #2347](https://xkcd.com/2347/) depicts this beautifully (and scientifically).
...
- Allocate a fresh $1 million for 2026 and look for projects to support in the [open directory](https://dir.floss.fund) listings. "Applications" are perpetual, so all listings in the open directory are re-evaluated periodically.
...
If you're a FOSS project, do "[apply](https://dir.floss.fund/submit)".
...
*PS: 100% of the em dashes in this post are human-generated*
